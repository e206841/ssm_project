package com.ln.core.orm.mybatis;
...
import com.ln.core.orm.dialect.Dialect;
import com.ln.core.orm.dialect.DialectFactory;
...
public class PaginationStatementHandlerInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        /*int pageNo = total/page.getPageSize();
        int a = total%page.getPageSize();
        if(a>0){
        	pageNo++;
        }
